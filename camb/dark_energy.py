...
class DarkEnergyEqnOfState(DarkEnergyModel):
    ...
    _fields_ = [
        ...
        ("dde_model", c_int, "dynamical dark energy model to use"),
        ("pm_in", c_int, "determines the behavior of dark energy equation of state"),
        ("dde_freq", c_double, "frequency of oscillations for some dynamical models")
    ]

    _methods_ = [('SetWTable', [numpy_1d, numpy_1d, POINTER(c_int)])]

    def set_params(self, w=-1.0, wa=0, cs2=1.0, dde_model=0, pm_in=1, dde_freq=1.0):
        """
        ...
        self.wa = wa
        self.cs2 = cs2
        self.dde_model = dde_model
        self.pm_in = pm_in
        self.dde_freq = dde_freq
