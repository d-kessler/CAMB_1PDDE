...
class CAMBparams(F2003Class):
    ...
    def set_dark_energy(self, w=-1.0, cs2=1.0, wa=0, dark_energy_model='fluid', dde_model=0, pm_in=1, dde_freq=1.0):
        r"""
        ...
        de.set_params(w=w, wa=wa, cs2=cs2, dde_model=dde_model, pm_in=pm_in, dde_freq=dde_freq)
        self.DarkEnergy = de
        return self
